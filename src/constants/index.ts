export const KCC = {
  ...
  DOCS_URL: '/',
  GITHUB_URL: 'https://github.com/Beagleinu',
  DAPP_URL: '/',
  DISCORD_URL: '/',
  MEDIA_URL: '/',
  MEDIA_API: '/',
  MAIL_SUBSCRIBE_PROXY: 'https://mailsubscribe.kcc.io/mailchimp-subscribe',
  TWITTER: 'https://twitter.com/Beaglelnu_bsc',
  TELEGRAM: 'https://t.me/BeagleInuGlobal',
  ...
  CONTACT_LIST: [
    {
      ...
      route: 'https://twitter.com/Beaglelnu_bsc',
    },
    {
      app: 'Telegram',
  ...
  MILESTONES: [
    {
      date: 'Beagle Inu (testnet) launched',
      title: 'Milestone 1',
    },
    {
      date: 'Beagle Inu launched',
      title: 'Milestone 2',
      icon: require('../assets/images/home/milestone-icon@2x.png').default,
    },
    {
      date: 'Grant Program launched',
      title: 'Milestone 3',
      icon: require('../assets/images/home/milestone-icon@2x.png').default,
    },
    {
      date: 'Beagle Inu Ambassador Program',
      title: '',
      icon: require('../assets/images/home/milestone-icon@2x.png').default,
    },
    {
      date: 'Beagle Inu Bridge Launched',
      title: '',
      icon: require('../assets/images/home/milestone-icon@2x.png').default,
    },
    {
